...
class SequentialGeventHandler(object):
    ...
    # We have to do this after create_connection is defined, as mypy gets
    # confused about which socket we're referring to.
    def socket(self, *args: Any, **kwargs: Any) -> socket.socket:
