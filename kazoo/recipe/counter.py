...
class Counter(object):
    ...
    """
    def __init__(self, client, path, default=0, support_curator_shared_count=False):
        ...
        self.support_curator_shared_count = support_curator_shared_count
    ...
    def _value(self):
        ...
        if self.support_curator_shared_count:
