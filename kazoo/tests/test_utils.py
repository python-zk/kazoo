...
class TestCreateTCPConnection(unittest.TestCase):
    ...
    def test_ssl_server_hostname(self) -> None:
        with patch.object(utils, "_set_default_tcpsock_options"):
    ...
    def test_ssl_server_check_hostname(self) -> None:
        with patch.object(utils, "_set_default_tcpsock_options"):
            with patch.object(
    ...
    def test_ssl_server_check_hostname_config_validation(self) -> None:
    ...
    def test_timeout_arg_eventlet(self) -> None:
        ...
        with patch.object(
            ...
            with patch.object(utils, "_set_default_tcpsock_options"):
                ...
                with patch.object(time, "time", side_effect=range(10)):
                    create_tcp_connection(
                        green_socket, ("127.0.0.1", 2181), timeout=1.5
                    )
