...
class ZkEnsemble:
    ...
    def get_client(
        ...
        if superadmin:
            ...
            # authentication via superDigest in the server JVM flags
            # (-Dzookeeper.DigestAuthenticationProvider.superDigest=...).
            # The client then authenticates with password "super_secret".
...
def _export_krb5_client_env(
    ...
    publishers: list[PublishedPortModel] = container.Publishers  # type: ignore[assignment]
