...
_RETRY_COMPAT_DEFAULTS = dict(
    max_retries=None, retry_delay=0.1, retry_backoff=2, retry_max_delay=3600
)
...
class KazooClient:
    ...
    def set_hosts(
        self, hosts: str | list[str], randomize_hosts: bool | None = None
    ) -> None:
...
class TransactionRequest:
    ...
    def _add(
        self, request: Any, post_processor: Callable[[Any], Any] | None = None
    ) -> None:
        self._check_tx_state()
